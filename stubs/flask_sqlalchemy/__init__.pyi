# Stubs for flask_sqlalchemy (Python 3)
#
...
class BaseQuery(orm.Query):
    ...
    def paginate(self, page: Optional[Any] = ..., per_page: Optional[Any] = ..., error_out: bool = ..., max_per_page: Optional[Any] = ..., count: bool = ...): ...
...
class SQLAlchemy:
    ...
    def test_this_stub(self, bind: str = ..., app: Optional[Any] = ...) -> None: ...
